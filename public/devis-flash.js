...
function repartirDeZero() {
  ...
  // L'ADRESSE DU CLIENT est arrivée par la branche de la facture : un devis
  // neuf doit la vider comme les autres champs, sinon elle survit d'un client
  // au suivant — et c'est elle qui part sur un document opposable.
