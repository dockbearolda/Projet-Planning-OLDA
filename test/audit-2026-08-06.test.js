...
(async () => {
  ...
  const notify = bloc(DASH, '  function notifyChange() {');
  const bacDash = {
  ...
  bacDash.notifyChange();
  assert.strictEqual(bacDash.appels, 0, 'onglet en veille : on ne rejoue pas le planning entier');
