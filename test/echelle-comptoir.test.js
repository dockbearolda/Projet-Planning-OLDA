...
// patron), grossie le 25/08 pour le 15,4 pouces Windows du poste, puis
// UNIFORMISÉE le soir même : ce qui se lit ET se saisit en 17, tout le petit
// texte (intitulé, aide, mention) en 14, chiffres annoncés en 32 — par
// surcharge DE PORTÉE sous `.ecran-comptoir`, le `:root` ne bouge pas. Les
// quatre jetons `--dd-taille-*` demeurent : des RÔLES, repliés sur deux
// valeurs, déclarés une seule fois dans charte.css. La règle ne change pas :
// rien en dur, tout se nomme.
