...
| Journal des factures | Liste par année et export CSV pour le comptable, depuis Réglages | Actif | `server.js` (`GET /api/factures`, `GET /api/factures.csv`), `public/reglages.js` (`renderJournal`) |
