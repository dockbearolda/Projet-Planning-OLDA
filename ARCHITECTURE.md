...
| Agenda des retraits | Le planning rangé par JOUR : qui vient chercher quoi aujourd'hui, demain, après. Entrée en tête du rail, `#agenda` | Actif | `public/agenda.js`, `public/agenda.css`, `server.js` (`GET /api/agenda`) |
...
| Les trois papiers | Ticket atelier, bon de commande, devis A4, sur un socle commun | Actif | `public/ticket.js`, `public/bureau.js`, `public/devis.js`, `public/papier.js` |
